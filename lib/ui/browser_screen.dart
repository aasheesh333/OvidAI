...
class _BrowserScreenState extends State<BrowserScreen> {
  ...
  void initState() {
    ...
    // Register with agent so browser_open / browser_navigate drive this webview.
    AgentService.I.bindWebView(_c);
  }

  @override
  void dispose() {
    AgentService.I.unbindWebView();
    _url.dispose();
    super.dispose();
  }
              ...
              child: Row(children: [
                ...
                IconButton(
                  ...
                  icon: const Icon(Icons.refresh,
                      size: 17, color: Aether.textMuted),
                  onPressed: () => _c.reload(),
                ),
                Expanded(
                  child: Container(
